    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-16 md:pt-24 pb-20 grid md:grid-cols-12 gap-10 md:gap-16 items-center">
        ...
        <div className="md:col-span-7 text-left">
          ...
          >
            Sagar
            <span className="amp inline md:mx-4 italic font-light px-2">
              &amp;
            </span>
            Simran
          </motion.h1>
          ...
          >
            <div className="overline">23 · 24 · 25 June, 2026</div>
          ...
          >
            <a href="#schedule" className="pill-btn">
              View Schedule
            </a>
            <a href="#venue" className="pill-btn pill-btn-accent">
              Find the Venue
            </a>
          </motion.div>
        </div>
        ...
        >
          <div className="relative w-full aspect-[3/4] max-w-sm mx-auto md:ml-auto">
      ...
      {/* Scroll cue */}
      <div className="relative z-10 flex flex-col items-center gap-2 pb-6 mt-4">
